                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="submenu-2" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/cards.html">Cards <span class="badge badge-secondary">New</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/general.html">General</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/carousel.html">Carousel</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/listgroup.html">List Group</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/typography.html">Typography</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/accordions.html">Accordions</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/tabs.html">Tabs</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div id="submenu-3" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/chart-c3.html">C3 Charts</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/chart-chartist.html">Chartist Charts</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/chart-charts.html">Chart</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/chart-morris.html">Morris</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/chart-sparkline.html">Sparkline</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/chart-gauge.html">Guage</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item ">
                        ...
                        <div id="submenu-4" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/form-validation.html">Parsely Validations</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/multiselect.html">Multiselect</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/datepicker.html">Date Picker</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/bootstrap-select.html">Bootstrap Select</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div id="submenu-5" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/general-table.html">General Tables</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin/pages/data-tables.html">Data Tables</a>
                                </li>
                            </ul>
                        </div>
                    </li>
